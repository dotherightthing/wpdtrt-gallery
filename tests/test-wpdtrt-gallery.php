...
class WPDTRT_GalleryTest extends WP_UnitTestCase {
	 ...
	 * Fixture.
	 */
	private $gallery_html = '<div class="wpdtrt-gallery__section" id="test-section"><div class="wpdtrt-gallery-viewer stack stack--gallery-viewer" data-enabled="false" data-expanded="false"><div class="wpdtrt-gallery-viewer__header"><h2>Post 1 heading</h2></div><div class="stack__wrapper"><figure class="stack__liner"><div class="img-wrapper"></div><div class="wpdtrt-gallery-viewer__embed"><iframe aria-hidden="true" title="Gallery media viewer."></iframe></div><figcaption class="wpdtrt-gallery-viewer__footer"><div class="wpdtrt-gallery-viewer__caption"></div></figcaption></figure></div></div></div>';
