 ...
 * @since   1.0.0
 */
class WPDTRT_Gallery_Plugin extends DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_5_0\Plugin {
	 ...
	 */
	public function filter_image_quality( $quality ) {
		return 100;
	}
	 ...
	 * @param bool   $permalink Permalink.
	 * @return string
