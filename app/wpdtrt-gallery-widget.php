...
if ( !class_exists( 'WPDTRT_Gallery_Widget' ) ) {
   ...
   */
  class WPDTRT_Gallery_Widget extends WP_Widget {

    function __construct() {
      // Instantiate the parent object
      parent::__construct( false, 'DTRT Gallery Widget' );
    }
     ...
     * This function's variables will be available to this template.
     */
      require(WPDTRT_GALLERY_PATH . 'templates/wpdtrt-gallery-widget.php');
    }
  }

}

if ( !function_exists( 'wpdtrt_gallery_register_widgets' ) ) {
  ...
  function wpdtrt_gallery_register_widgets() {
    register_widget( 'WPDTRT_Gallery_Widget' );
  }

  add_action( 'widgets_init', 'wpdtrt_gallery_register_widgets' );
